// src/lib.rs
/*
 * Core library for TanStackQuery
 */
...
#[derive(Debug)]
pub struct TanStackQueryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TanStackQueryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TanStackQuery processing");
    
    let mut processor = TanStackQueryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TanStackQueryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TanStackQueryProcessor::new(false);
